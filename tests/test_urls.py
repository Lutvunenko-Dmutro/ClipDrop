...
def test_tiktok_invalid_urls():
    ...
    assert is_tiktok_homepage_or_photo("https://www.tiktok.com/@user/video/123?aweme_type=150") == True
    assert is_tiktok_homepage_or_photo("https://www.tiktok.com/@user/video/123") == False
